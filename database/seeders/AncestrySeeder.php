...
class AncestrySeeder extends Seeder
{
    ...
    public function run(): void
    {
        Ancestry::factory()->create([
            ...
            'speed' => 25,
            'ability_boosts' => [
                'default'=>['Dexterity', 'Charisma'],
                'free_boost'=> 1
            ],
            'ability_flaw' => 'Wisdom',
            'languages' => [
                'default'=>['Common', 'Goblin'],
                'additional'=> ['Draconic', 'Dwarven', 'Gnoll', 'Gnomish', 'Halfling', 'Orcish']
            ],
        ...
        Ancestry::factory()->create([
            ...
            'speed' => 20,
            'ability_boosts' => [
                'default'=>['Constitution', 'Wisdom'],
                'free_boost'=> 1
            ],
            'ability_flaw' => 'Charisma',
            'languages' => [
                'default'=>['Common', 'Dwarven'],
                'additional'=> ['Gnomish', 'Goblin', 'Jotun', 'Orcish', 'Terran', 'Undercommon']
            ],
